...
static void SCB_1_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void SCB_1_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            hsiomSel[SCB_1_RX_SCL_MOSI_PIN_INDEX] = SCB_1_HSIOM_I2C_SEL;
            hsiomSel[SCB_1_TX_SDA_MISO_PIN_INDEX] = SCB_1_HSIOM_I2C_SEL;
        ...
        {
            hsiomSel[SCB_1_RX_SCL_MOSI_PIN_INDEX] = SCB_1_HSIOM_SPI_SEL;
            hsiomSel[SCB_1_TX_SDA_MISO_PIN_INDEX] = SCB_1_HSIOM_SPI_SEL;
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[SCB_1_TX_SDA_MISO_PIN_INDEX] = SCB_1_HSIOM_UART_SEL;
                pinsDm  [SCB_1_TX_SDA_MISO_PIN_INDEX] = SCB_1_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                ...
                {
                    hsiomSel[SCB_1_RX_SCL_MOSI_PIN_INDEX] = SCB_1_HSIOM_UART_SEL;
                    pinsDm  [SCB_1_RX_SCL_MOSI_PIN_INDEX] = SCB_1_PIN_DM_DIG_HIZ;
                }
    ...
    #if (SCB_1_SCLK_PIN)
        SCB_1_SET_HSIOM_SEL(SCB_1_SCLK_HSIOM_REG,
                                       SCB_1_SCLK_HSIOM_MASK,
                                       SCB_1_SCLK_HSIOM_POS,
                                       hsiomSel[SCB_1_SCLK_PIN_INDEX]);
    ...
    #if (SCB_1_SS0_PIN)
        SCB_1_SET_HSIOM_SEL(SCB_1_SS0_HSIOM_REG,
                                       SCB_1_SS0_HSIOM_MASK,
                                       SCB_1_SS0_HSIOM_POS,
                                       hsiomSel[SCB_1_SS0_PIN_INDEX]);
