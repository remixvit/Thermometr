// ======================================================================
// Thermometr.v generated from TopDesign.cysch
// 01/21/2016 at 23:30
...
module SCB_P4_v3_0_0 (
	...
	cy_clock_v1_0
		#(.id("f71fa961-f2b4-43be-91a6-1a9d60930899/2dc2d7a8-ce2b-43c7-af4a-821c8cd73ccf"),
		  .source_clock_id(""),
		  .divisor(0),
...
module SCB_P4_v3_0_1 (
	...
	cy_clock_v1_0
		#(.id("78388b99-a9cc-464e-8902-c8922a3ab14c/2dc2d7a8-ce2b-43c7-af4a-821c8cd73ccf"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
`ifdef WARP
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\demux_v1_10"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\demux_v1_10\demux_v1_10.v"
`else
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\demux_v1_10"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\demux_v1_10\demux_v1_10.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyControlReg_v1_80"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyControlReg_v1_80\CyControlReg_v1_80.v"
`else
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyControlReg_v1_80"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyControlReg_v1_80\CyControlReg_v1_80.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\not_v1_0"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\not_v1_0\not_v1_0.v"
`else
`define CY_BLK_DIR "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\not_v1_0"
`include "C:\My Programs\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\not_v1_0\not_v1_0.v"
`endif
...
module top ;
    ...
    PWM_v3_30_2 LED_SEG_PWM (
        ...
        .ph1(Net_980),
        .ph2(Net_981));
    defparam LED_SEG_PWM.Resolution = 8;
    ...
    begin : demux_1
        ...
        always @(Net_1057 or Net_1058)
        begin
            case (Net_1058[1:0])
                2'b00:
                begin
                    tmp__demux_1_0_reg = Net_1057;
                ...
                begin
                    ...
                    tmp__demux_1_1_reg = 1'b0;
                    tmp__demux_1_2_reg = 1'b0;
                    tmp__demux_1_3_reg = Net_1057;
                end
            endcase
        end
        assign Net_1059 = tmp__demux_1_0_reg;
        assign Net_1042 = tmp__demux_1_1_reg;
        assign Net_1044 = tmp__demux_1_2_reg;
        assign Net_1046 = tmp__demux_1_3_reg;
    end
    // -- De Mux end --
	...
	cy_clock_v1_0
		#(.id("494bdad0-8ed4-4c49-9e92-00b9b4c2575e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
    ...
    CyControlReg_v1_80 PWM_Mux_Reg (
        .control_1(Net_369),
        .control_2(Net_370),
        .control_3(Net_371),
        .control_0(Net_372),
        ...
        .clock(1'b0),
        .reset(1'b0),
        .control_bus(Net_1058[1:0]));
    defparam PWM_Mux_Reg.Bit0Mode = 0;
    defparam PWM_Mux_Reg.Bit1Mode = 0;
    defparam PWM_Mux_Reg.Bit2Mode = 0;
    defparam PWM_Mux_Reg.Bit3Mode = 0;
    defparam PWM_Mux_Reg.Bit4Mode = 0;
    defparam PWM_Mux_Reg.Bit5Mode = 0;
    defparam PWM_Mux_Reg.Bit6Mode = 0;
    defparam PWM_Mux_Reg.Bit7Mode = 0;
    defparam PWM_Mux_Reg.BitValue = 0;
    defparam PWM_Mux_Reg.BusDisplay = 1;
    defparam PWM_Mux_Reg.ExtrReset = 0;
    defparam PWM_Mux_Reg.NumOutputs = 2;
    ...
    assign Net_1036 = ~Net_1059;


    assign Net_1037 = ~Net_1042;


    assign Net_1038 = ~Net_1044;


    assign Net_1039 = ~Net_1046;
