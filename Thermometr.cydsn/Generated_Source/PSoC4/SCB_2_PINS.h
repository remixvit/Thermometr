...
/* Unconfigured pins */
#define SCB_2_REMOVE_RX_WAKE_SCL_MOSI_PIN  (1u)
#define SCB_2_REMOVE_RX_SCL_MOSI_PIN      (1u)
#define SCB_2_REMOVE_TX_SDA_MISO_PIN      (1u)
#define SCB_2_REMOVE_SCLK_PIN      (1u)
#define SCB_2_REMOVE_SS0_PIN      (1u)
...
/* Unconfigured pins */
#define SCB_2_RX_WAKE_SCL_MOSI_PIN (0u == SCB_2_REMOVE_RX_WAKE_SCL_MOSI_PIN)
#define SCB_2_RX_SCL_MOSI_PIN     (0u == SCB_2_REMOVE_RX_SCL_MOSI_PIN)
#define SCB_2_TX_SDA_MISO_PIN     (0u == SCB_2_REMOVE_TX_SDA_MISO_PIN)
#define SCB_2_SCLK_PIN     (0u == SCB_2_REMOVE_SCLK_PIN)
#define SCB_2_SS0_PIN     (0u == SCB_2_REMOVE_SS0_PIN)
...
#if (SCB_2_RX_WAKE_SCL_MOSI_PIN)
    #include "SCB_2_uart_rx_wake_i2c_scl_spi_mosi.h"
#endif /* (SCB_2_RX_SCL_MOSI) */

#if (SCB_2_RX_SCL_MOSI_PIN)
    #include "SCB_2_uart_rx_i2c_scl_spi_mosi.h"
#endif /* (SCB_2_RX_SCL_MOSI) */

#if (SCB_2_TX_SDA_MISO_PIN)
    #include "SCB_2_uart_tx_i2c_sda_spi_miso.h"
#endif /* (SCB_2_TX_SDA_MISO) */

#if (SCB_2_SCLK_PIN)
    #include "SCB_2_spi_sclk.h"
#endif /* (SCB_2_SCLK) */

#if (SCB_2_SS0_PIN)
    #include "SCB_2_spi_ss0.h"
#endif /* (SCB_2_SS0_PIN) */
...
***************************************/
...
#if (SCB_2_RX_WAKE_SCL_MOSI_PIN)
    #define SCB_2_RX_WAKE_SCL_MOSI_HSIOM_REG \
                            (*(reg32 *) SCB_2_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define SCB_2_RX_WAKE_SCL_MOSI_HSIOM_PTR \
                            ( (reg32 *) SCB_2_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define SCB_2_RX_WAKE_SCL_MOSI_HSIOM_MASK \
                            (SCB_2_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define SCB_2_RX_WAKE_SCL_MOSI_HSIOM_POS \
                            (SCB_2_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SHIFT)

    #define SCB_2_RX_WAKE_SCL_MOSI_INTCFG_REG \
                            (*(reg32 *) SCB_2_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define SCB_2_RX_WAKE_SCL_MOSI_INTCFG_PTR \
                            ( (reg32 *) SCB_2_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define SCB_2_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS  (SCB_2_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
    #define SCB_2_RX_WAKE_SCL_MOSI_INTCFG_TYPE_MASK \
                            ((uint32) SCB_2_INTCFG_TYPE_MASK << \
                                      SCB_2_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS)
#endif /* (SCB_2_RX_WAKE_SCL_MOSI_PIN) */

#if (SCB_2_RX_SCL_MOSI_PIN)
    #define SCB_2_RX_SCL_MOSI_HSIOM_REG   (*(reg32 *) SCB_2_uart_rx_i2c_scl_spi_mosi__0__HSIOM)
    #define SCB_2_RX_SCL_MOSI_HSIOM_PTR   ( (reg32 *) SCB_2_uart_rx_i2c_scl_spi_mosi__0__HSIOM)
    #define SCB_2_RX_SCL_MOSI_HSIOM_MASK  (SCB_2_uart_rx_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define SCB_2_RX_SCL_MOSI_HSIOM_POS   (SCB_2_uart_rx_i2c_scl_spi_mosi__0__HSIOM_SHIFT)
#endif /* (SCB_2_RX_SCL_MOSI_PIN) */

#if (SCB_2_TX_SDA_MISO_PIN)
    #define SCB_2_TX_SDA_MISO_HSIOM_REG   (*(reg32 *) SCB_2_uart_tx_i2c_sda_spi_miso__0__HSIOM)
    #define SCB_2_TX_SDA_MISO_HSIOM_PTR   ( (reg32 *) SCB_2_uart_tx_i2c_sda_spi_miso__0__HSIOM)
    #define SCB_2_TX_SDA_MISO_HSIOM_MASK  (SCB_2_uart_tx_i2c_sda_spi_miso__0__HSIOM_MASK)
    #define SCB_2_TX_SDA_MISO_HSIOM_POS   (SCB_2_uart_tx_i2c_sda_spi_miso__0__HSIOM_SHIFT)
#endif /* (SCB_2_TX_SDA_MISO_PIN) */

#if (SCB_2_SCLK_PIN)
    #define SCB_2_SCLK_HSIOM_REG   (*(reg32 *) SCB_2_spi_sclk__0__HSIOM)
    #define SCB_2_SCLK_HSIOM_PTR   ( (reg32 *) SCB_2_spi_sclk__0__HSIOM)
    #define SCB_2_SCLK_HSIOM_MASK  (SCB_2_spi_sclk__0__HSIOM_MASK)
    #define SCB_2_SCLK_HSIOM_POS   (SCB_2_spi_sclk__0__HSIOM_SHIFT)
#endif /* (SCB_2_SCLK_PIN) */

#if (SCB_2_SS0_PIN)
    #define SCB_2_SS0_HSIOM_REG   (*(reg32 *) SCB_2_spi_ss0__0__HSIOM)
    #define SCB_2_SS0_HSIOM_PTR   ( (reg32 *) SCB_2_spi_ss0__0__HSIOM)
    #define SCB_2_SS0_HSIOM_MASK  (SCB_2_spi_ss0__0__HSIOM_MASK)
    #define SCB_2_SS0_HSIOM_POS   (SCB_2_spi_ss0__0__HSIOM_SHIFT)
#endif /* (SCB_2_SS0_PIN) */
    ...
    #define SCB_2_TX_HSIOM_PTR   ( (reg32 *) SCB_2_tx_0__HSIOM)
...
#define SCB_2_RX_WAKE_SCL_MOSI_PIN_INDEX   (0u)
#define SCB_2_RX_SCL_MOSI_PIN_INDEX       (0u)
#define SCB_2_TX_SDA_MISO_PIN_INDEX       (1u)
#define SCB_2_SCLK_PIN_INDEX       (2u)
#define SCB_2_SS0_PIN_INDEX       (3u)
#define SCB_2_SS1_PIN_INDEX                  (4u)
#define SCB_2_SS2_PIN_INDEX                  (5u)
#define SCB_2_SS3_PIN_INDEX                  (6u)

#define SCB_2_RX_WAKE_SCL_MOSI_PIN_MASK ((uint32) 0x01u << SCB_2_RX_WAKE_SCL_MOSI_PIN_INDEX)
#define SCB_2_RX_SCL_MOSI_PIN_MASK     ((uint32) 0x01u << SCB_2_RX_SCL_MOSI_PIN_INDEX)
#define SCB_2_TX_SDA_MISO_PIN_MASK     ((uint32) 0x01u << SCB_2_TX_SDA_MISO_PIN_INDEX)
#define SCB_2_SCLK_PIN_MASK     ((uint32) 0x01u << SCB_2_SCLK_PIN_INDEX)
#define SCB_2_SS0_PIN_MASK     ((uint32) 0x01u << SCB_2_SS0_PIN_INDEX)
...
#define SCB_2_DM_SIZE    (3)
#define SCB_2_GET_P4_PIN_DM(reg, pos) \
    ( ((reg) & (uint32) ((uint32) SCB_2_DM_MASK << (SCB_2_DM_SIZE * (pos)))) >> \
                                                              (SCB_2_DM_SIZE * (pos)) )

#if (SCB_2_TX_SDA_MISO_PIN)
    #define SCB_2_CHECK_TX_SDA_MISO_PIN_USED \
                (SCB_2_PIN_DM_ALG_HIZ != \
                    SCB_2_GET_P4_PIN_DM(SCB_2_uart_tx_i2c_sda_spi_miso_PC, \
                                                   SCB_2_uart_tx_i2c_sda_spi_miso_SHIFT))
#endif /* (SCB_2_TX_SDA_MISO_PIN) */

#if (SCB_2_SS0_PIN)
    #define SCB_2_CHECK_SS0_PIN_USED \
                (SCB_2_PIN_DM_ALG_HIZ != \
                    SCB_2_GET_P4_PIN_DM(SCB_2_spi_ss0_PC, \
                                                   SCB_2_spi_ss0_SHIFT))
#endif /* (SCB_2_SS0_PIN) */
...
#elif (SCB_2_RX_WAKE_SCL_MOSI_PIN)
    #define SCB_2_SET_I2C_SCL_DR(val) \
                            SCB_2_uart_rx_wake_i2c_scl_spi_mosi_Write(val)

    #define SCB_2_SET_I2C_SCL_HSIOM_SEL(sel) \
                    SCB_2_SET_HSIOM_SEL(SCB_2_RX_WAKE_SCL_MOSI_HSIOM_REG,  \
                                                   SCB_2_RX_WAKE_SCL_MOSI_HSIOM_MASK, \
                                                   SCB_2_RX_WAKE_SCL_MOSI_HSIOM_POS,  \
                                                   (sel))

    #define SCB_2_WAIT_SCL_SET_HIGH  (0u == SCB_2_uart_rx_wake_i2c_scl_spi_mosi_Read())

#elif (SCB_2_RX_SCL_MOSI_PIN)
    #define SCB_2_SET_I2C_SCL_DR(val) \
                            SCB_2_uart_rx_i2c_scl_spi_mosi_Write(val)


    #define SCB_2_SET_I2C_SCL_HSIOM_SEL(sel) \
                            SCB_2_SET_HSIOM_SEL(SCB_2_RX_SCL_MOSI_HSIOM_REG,  \
                                                           SCB_2_RX_SCL_MOSI_HSIOM_MASK, \
                                                           SCB_2_RX_SCL_MOSI_HSIOM_POS,  \
                                                           (sel))

    #define SCB_2_WAIT_SCL_SET_HIGH  (0u == SCB_2_uart_rx_i2c_scl_spi_mosi_Read())
...
#elif (SCB_2_TX_SDA_MISO_PIN)
    #define SCB_2_WAIT_SDA_SET_HIGH  (0u == SCB_2_uart_tx_i2c_sda_spi_miso_Read())
#else
...
/* Unconfigured pins */
#define SCB_2_REMOVE_MOSI_SCL_RX_WAKE_PIN    SCB_2_REMOVE_RX_WAKE_SCL_MOSI_PIN
#define SCB_2_REMOVE_MOSI_SCL_RX_PIN         SCB_2_REMOVE_RX_SCL_MOSI_PIN
#define SCB_2_REMOVE_MISO_SDA_TX_PIN         SCB_2_REMOVE_TX_SDA_MISO_PIN
#ifndef SCB_2_REMOVE_SCLK_PIN
#define SCB_2_REMOVE_SCLK_PIN                SCB_2_REMOVE_SCLK_PIN
#endif /* SCB_2_REMOVE_SCLK_PIN */
#ifndef SCB_2_REMOVE_SS0_PIN
#define SCB_2_REMOVE_SS0_PIN                 SCB_2_REMOVE_SS0_PIN
#endif /* SCB_2_REMOVE_SS0_PIN */

/* Unconfigured pins */
#define SCB_2_MOSI_SCL_RX_WAKE_PIN   SCB_2_RX_WAKE_SCL_MOSI_PIN
#define SCB_2_MOSI_SCL_RX_PIN        SCB_2_RX_SCL_MOSI_PIN
#define SCB_2_MISO_SDA_TX_PIN        SCB_2_TX_SDA_MISO_PIN
#ifndef SCB_2_SCLK_PIN
#define SCB_2_SCLK_PIN               SCB_2_SCLK_PIN
#endif /* SCB_2_SCLK_PIN */
#ifndef SCB_2_SS0_PIN
#define SCB_2_SS0_PIN                SCB_2_SS0_PIN
#endif /* SCB_2_SS0_PIN */

#if (SCB_2_MOSI_SCL_RX_WAKE_PIN)
    #define SCB_2_MOSI_SCL_RX_WAKE_HSIOM_REG     SCB_2_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define SCB_2_MOSI_SCL_RX_WAKE_HSIOM_PTR     SCB_2_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define SCB_2_MOSI_SCL_RX_WAKE_HSIOM_MASK    SCB_2_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define SCB_2_MOSI_SCL_RX_WAKE_HSIOM_POS     SCB_2_RX_WAKE_SCL_MOSI_HSIOM_REG

    #define SCB_2_MOSI_SCL_RX_WAKE_INTCFG_REG    SCB_2_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define SCB_2_MOSI_SCL_RX_WAKE_INTCFG_PTR    SCB_2_RX_WAKE_SCL_MOSI_HSIOM_REG

    #define SCB_2_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS   SCB_2_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define SCB_2_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK  SCB_2_RX_WAKE_SCL_MOSI_HSIOM_REG
#endif /* (SCB_2_RX_WAKE_SCL_MOSI_PIN) */

#if (SCB_2_MOSI_SCL_RX_PIN)
    #define SCB_2_MOSI_SCL_RX_HSIOM_REG      SCB_2_RX_SCL_MOSI_HSIOM_REG
    #define SCB_2_MOSI_SCL_RX_HSIOM_PTR      SCB_2_RX_SCL_MOSI_HSIOM_PTR
    #define SCB_2_MOSI_SCL_RX_HSIOM_MASK     SCB_2_RX_SCL_MOSI_HSIOM_MASK
    #define SCB_2_MOSI_SCL_RX_HSIOM_POS      SCB_2_RX_SCL_MOSI_HSIOM_POS
#endif /* (SCB_2_MOSI_SCL_RX_PIN) */

#if (SCB_2_MISO_SDA_TX_PIN)
    #define SCB_2_MISO_SDA_TX_HSIOM_REG      SCB_2_TX_SDA_MISO_HSIOM_REG
    #define SCB_2_MISO_SDA_TX_HSIOM_PTR      SCB_2_TX_SDA_MISO_HSIOM_REG
    #define SCB_2_MISO_SDA_TX_HSIOM_MASK     SCB_2_TX_SDA_MISO_HSIOM_REG
    #define SCB_2_MISO_SDA_TX_HSIOM_POS      SCB_2_TX_SDA_MISO_HSIOM_REG
#endif /* (SCB_2_MISO_SDA_TX_PIN_PIN) */

#if (SCB_2_SCLK_PIN)
    #ifndef SCB_2_SCLK_HSIOM_REG
    #define SCB_2_SCLK_HSIOM_REG     SCB_2_SCLK_HSIOM_REG
    #define SCB_2_SCLK_HSIOM_PTR     SCB_2_SCLK_HSIOM_PTR
    #define SCB_2_SCLK_HSIOM_MASK    SCB_2_SCLK_HSIOM_MASK
    #define SCB_2_SCLK_HSIOM_POS     SCB_2_SCLK_HSIOM_POS
    #endif /* SCB_2_SCLK_HSIOM_REG */
#endif /* (SCB_2_SCLK_PIN) */

#if (SCB_2_SS0_PIN)
    #ifndef SCB_2_SS0_HSIOM_REG
    #define SCB_2_SS0_HSIOM_REG      SCB_2_SS0_HSIOM_REG
    #define SCB_2_SS0_HSIOM_PTR      SCB_2_SS0_HSIOM_PTR
    #define SCB_2_SS0_HSIOM_MASK     SCB_2_SS0_HSIOM_MASK
    #define SCB_2_SS0_HSIOM_POS      SCB_2_SS0_HSIOM_POS
    #endif /* SCB_2_SS0_HSIOM_REG */
#endif /* (SCB_2_SS0_PIN) */

#define SCB_2_MOSI_SCL_RX_WAKE_PIN_INDEX SCB_2_RX_WAKE_SCL_MOSI_PIN_INDEX
#define SCB_2_MOSI_SCL_RX_PIN_INDEX      SCB_2_RX_SCL_MOSI_PIN_INDEX
#define SCB_2_MISO_SDA_TX_PIN_INDEX      SCB_2_TX_SDA_MISO_PIN_INDEX
#ifndef SCB_2_SCLK_PIN_INDEX
#define SCB_2_SCLK_PIN_INDEX             SCB_2_SCLK_PIN_INDEX
#endif /* SCB_2_SCLK_PIN_INDEX */
#ifndef SCB_2_SS0_PIN_INDEX
#define SCB_2_SS0_PIN_INDEX              SCB_2_SS0_PIN_INDEX
#endif /* SCB_2_SS0_PIN_INDEX */

#define SCB_2_MOSI_SCL_RX_WAKE_PIN_MASK SCB_2_RX_WAKE_SCL_MOSI_PIN_MASK
#define SCB_2_MOSI_SCL_RX_PIN_MASK      SCB_2_RX_SCL_MOSI_PIN_MASK
#define SCB_2_MISO_SDA_TX_PIN_MASK      SCB_2_TX_SDA_MISO_PIN_MASK
#ifndef SCB_2_SCLK_PIN_MASK
#define SCB_2_SCLK_PIN_MASK             SCB_2_SCLK_PIN_MASK
#endif /* SCB_2_SCLK_PIN_MASK */
#ifndef SCB_2_SS0_PIN_MASK
#define SCB_2_SS0_PIN_MASK              SCB_2_SS0_PIN_MASK
